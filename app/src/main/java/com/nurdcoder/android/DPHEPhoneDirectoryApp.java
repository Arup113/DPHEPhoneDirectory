...
import com.nurdcoder.android.dphe_phone_directory.BuildConfig;
import com.nurdcoder.android.dphe_phone_directory.R;
import com.nurdcoder.android.dphe_phone_directory.data.helper.RemoteHelper;
import com.nurdcoder.android.dphe_phone_directory.data.local.dbstorage.DatabaseService;
import com.nurdcoder.android.dphe_phone_directory.data.remote.RemoteApi;
...
public class DPHEPhoneDirectoryApp extends MultiDexApplication {

    public static final String TAG = DPHEPhoneDirectoryApp.class.getSimpleName();
    private static DPHEPhoneDirectoryApp mInstance;
    private RequestQueue mRequestQueue;
//    private Tracker mTracker;

    public static synchronized DPHEPhoneDirectoryApp getInstance() {
        return mInstance;
    }
